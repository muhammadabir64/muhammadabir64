<h1 align="center">Hi there, I'm Muhammad Abir 👋</h1>

<h3 align="center">Building web apps, scrapers, and automation tools that just work</h3>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=2E9EF7&center=true&vCenter=true&width=600&lines=Full+Stack+Web+Developer;Python+%7C+Django+%7C+FastAPI;Node.js+%7C+Express+%7C+React;Building+robust%2C+scalable+web+apps" alt="Typing SVG" />
</p>
...
I'm an enthusiastic **Full Stack Web Developer**, dedicated to crafting robust and scalable web applications using a diverse set of technologies. I enjoy solving real-world problems with clean code and modern tooling.

- Backend-heavy full-stack developer- Django, FastAPI, NodeJS and Laravel are where I'm strongest
- Spend a lot of time on scraping and automation work, turning unstructured data into usable systems
- Have worked remotely with international clients for years, mostly on long-term project arrangements
- Open to freelance and collaboration work. Email is the best way to reach me
